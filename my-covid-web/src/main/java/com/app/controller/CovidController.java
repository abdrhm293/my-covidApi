...
public class CovidController {
	...
	CovidCasesDesc addCovid(@RequestParam(required = true) String desc) throws Exception {
		...
		try {
			...
			covidCasesDesc = processCovidDesc(desc);
		} catch (Exception e) {
			// TODO Auto-generated catch block
	...
	@Transactional
	CovidCasesDesc postDescCovid(@RequestParam(required = true) String desc) throws Exception {
	...
	private CovidCasesDesc processCovidDesc(String desc) {
	...
	int deleteCovidSoap(@RequestParam(required = true) String desc) throws Exception {
		...
		// complete the implementation below
		int i = covidService.deleteDescWithCondition(desc);
	...
	List<String> findDuplicateNdelete() throws Exception {
		...
		for (String s: e) {
			...
			int records = covidService.deleteDuplicateDesc(s);
